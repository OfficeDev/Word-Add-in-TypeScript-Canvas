# <a name="image-callouts-word-add-in-sample:-load,-edit,-and-insert-images"></a>Пример надстройки Word для использования изображений с выносками: загрузка, редактирование и вставка изображений
